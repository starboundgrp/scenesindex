...
export default async function handler(request, response) {
  ...
  // we're just checking if the variables exist, not printing the actual keys.
  console.log('serverless function invoked.');
  console.log('is GOOGLE_API_KEY present?', !!apiKey);
  console.log('is GOOGLE_SEARCH_ENGINE_ID present?', !!searchEngineId);
  // --------------------------------
  ...
  if (!apiKey || !searchEngineId) {
    console.error('server error: api credentials not found. check vercel environment variables.');
